import { Banknote, CreditCard, History, Home, LogIn, LogOut, Settings, Users } from "lucide-react";
...
export const operatorNav: NavItem[] = [
  ...
  { label: "Saídas", href: "/frentista/saidas", icon: LogOut }, { label: "Veículos", href: "/frentista/veiculos", icon: VehicleGroupIcon },

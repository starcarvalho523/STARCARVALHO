...
export type EfiHttpRequest={path:"/oauth/token"|"/v2/cob"|`/v2/cob/${string}`|`/v2/loc/${number}/qrcode`|`/v2/webhook/${string}`;method:"POST"|"GET"|"PUT"|"PATCH"|"DELETE";headers:Record<string,string>;body:string};

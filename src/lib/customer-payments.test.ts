...
const period = { reference_year:2026, reference_month:8, monthly_subscriptions:{plan_name:"Plano mensal",parking_units:{name:"Central",timezone:"America/Bahia"}}, payments:[paidMonthly] };

  ...
  return (
    <DashboardShell nav={ceoNav} active="Clientes" role="CEO">
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        <GlobalForm className="grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:grid-cols-[minmax(0,1fr)_220px_190px_190px_auto]" action="/ceo/clientes">
